    ...
    return (
        <div className='fixed bg-gray-400/60 w-full h-full z-20'>
            <div className='flex justify-center items-center my-20'>
                <div className='p-8 bg-white shadow-md hover:shodow-lg rounded-2xl md:max-w-xl max-w-sm'>
                    <div className='flex items-center justify-between'>
                        <div className='flex items-center'>
                            ...
                            <div className='flex flex-col ml-3'>
                                ...
                                <p className='md:text-sm text-xs text-gray-600 leading-none mt-1'>{desc}</p>
                            </div>
                        </div>
