...
export default function Oktal() {
    ...
    const openModal = () => {
        pushPopUp(<Modal title='Kalkulator Konversi Oktal' desc='Kalkulator Konversi Bilangan Sistem Oktal adalah alat bantu hitung untuk mengkonversi bilangan sistem dari Oktal ke Desimal, Heksadesimal, ataupun Biner.' onClose={popPopUp} />)
    }
    ...
    return (
        <>
            <SEO title='Kalkulator Konversi Oktal - SATOE OENTOEK SEMOEAH' desc='Salah satu studi kasus alat hitung Konversi Bilangan Oktal oleh Naufal Akbar Nugroho' keyword='Oktal, Konversi, Kalkulator Oktal' url='https://satoeoentoeksemoeah.vercel.app/convert/octal' />
            <div className='dark:bg-gray-900 min-h-screen lg:overflow-x-auto overflow-x-hidden'>
                ...
                {loading ? (
                    ...
                    <>
                        <Chat text='Selamat datang di Kalkulator Konversi Oktal! Kalkulator Konversi Oktal adalah sebuah alat bantu hitung untuk menentukan hasil konversi bilangan oktal ke desimal, heksadesimal, ataupun biner. Selamat mencoba!' />
                                ...
                                <div className='container flex flex-col px-5 py-10 mx-auto lg:items-center'>
                                    <div className='border-2 p-5 rounded-lg lg:w-2/4 md:w-1/2 w-full'>
                                        <div className='flex justify-center items-center border-b'>
                                            <h1 className='font-bold text-xl mb-2'>Kalkulator Konversi Oktal</h1>
                                        ...
                                        <form onSubmit={calculate}>
                                            <div className='mt-2 flex flex-col'>
                                                ...
                                                <input type='text' onChange={(e) => setOktal(e.target.value)} value={oktal} id='nominal' className='w-full flex-1 bg-gray-white text-gray-800 placeholder-gray-400 border border-gray-300 focus:ring ring-blue-300 dark:ring-blue-500 rounded outline-none transition duration-100 px-3 py-2' required />
                                            </div>
                                            <div className='mt-2 flex flex-col'>
