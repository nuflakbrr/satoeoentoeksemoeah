...
import { Footer, Sidebar, SEO, Modal, Alert, Chat, Spinner } from '../components'
...
export default function BMI() {
    ...
    const openModal = () => {
        pushPopUp(<Modal title='Kalkulator BMI' desc='Adalah alat bantu hitung BMI (Body Mass Index). BMI adalah angka yang menjadi penilaian standar untuk menentukan apakah berat badan Anda tergolong normal, kurang, berlebih, atau obesitas.' onClose={popPopUp} />)
    }
